...
public class View {
    ...
    public static void view() {
        ...
        System.out.print("|    ");
        System.out.print(StartApp.team1.get(0).getInfo());
        tabSetter(StartApp.team1.get(0).getInfo().length(), l[0]);
        System.out.println(StartApp.team2.get(0).getInfo());
        ...
        for (int i = 2; i < 10; i++) {
            ...
            System.out.print("|    ");
            System.out.print(StartApp.team1.get(i-1).getInfo());
            tabSetter(StartApp.team1.get(i-1).getInfo().length(), l[0]);
            System.out.println(StartApp.team2.get(i-1).getInfo());
            System.out.println(midl10);
        }
        for (int j = 1; j < 11; j++) {
        ...
        System.out.print("|    ");
        System.out.print(StartApp.team1.get(9).getInfo());
        tabSetter(StartApp.team1.get(9).getInfo().length(), l[0]);
        System.out.println(StartApp.team2.get(9).getInfo());
